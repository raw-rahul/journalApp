package com.rawrahul.journalApp.scheduler;
...
import com.rawrahul.journalApp.repository.UserRepositoryImpl;
import com.rawrahul.journalApp.service.EmailService;
...
//            String entry = String.join("", fiteredEnteries);
